    ...
    <div className="main-details-container">
      <div className="header flex flex-col items-center justify-center gap-10 py-10 mx-10 font-Heading border-b-2 border-gray-300">
        <div className="flex gap-5 items-center justify-center">
          <h1 className="text-white text-6xl md:text-8xl font-semibold">
            Bitcoin
          </h1>
          <img
        ...
        <p className=" text-center text-white ">
          Bitcoin is a digital currency with a finite supply, allowing users to
          send/receive money without a central bank/government, often nicknamed
        </p>
      </div>
      ...
      <div className="coin-data flex flex-col gap-10 bg-white rounded-md mx-5 md:mx-10 text-center p-5">
        ...
        <div className="coin-stats flex flex-col gap-5 md:px-10">
          <div className="Price flex items-center text-gray-700 justify-between">
            ...
            <h2 className=" text-xl md:text-2xl font-semibold">$ 46.7K</h2>
          </div>
          <div className="Price flex items-center text-gray-700 justify-between">
            <div className="flex items-center gap-3">
              <svg
